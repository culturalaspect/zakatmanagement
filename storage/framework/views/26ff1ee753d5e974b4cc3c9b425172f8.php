                                    ...
                                    <div class="row">
                                        <div class="col-md-3 mb-3">
                                            ...
                                            <select id="filterGender" class="form-control form-control-sm">
                                                ...
                                                <?php $__currentLoopData = $uniqueGenders; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $gender): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <option value="<?php echo e(ucfirst($gender)); ?>"><?php echo e(ucfirst($gender)); ?></option>
                                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                            </select>
                                        </div>
                                        <div class="col-md-3 mb-3">
                                        ...
                                        <div class="col-md-3 mb-3">
                                            ...
                                            <select id="filterVerificationStatus" class="form-control form-control-sm">
                                                ...
                                                <?php $__currentLoopData = $uniqueVerificationStatuses; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $status): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\php_projects_new\zakat_beneficiaries\laravel_project\resources\views/local-zakat-committees/show.blade.php ENDPATH**/ ?>