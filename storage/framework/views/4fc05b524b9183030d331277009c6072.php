...
<?php $__env->startSection('title', config('app.name') . ' - Districts'); ?>
<?php $__env->startSection('page_title', 'Districts'); ?>
<?php $__env->startSection('breadcrumb', 'Districts'); ?>
            ...
            <div class="white_card_header">
                <div class="box_header m-0">
                    <div class="main-title">
                        <h3 class="m-0">Districts</h3>
                    </div>
                    <div class="header_more_tool">
                        <a href="<?php echo e(route('districts.create')); ?>" class="btn btn-primary">
                            <i class="ti-plus"></i> Add District
                        </a>
                    </div>
                </div>
            </div>
            <div class="white_card_body">
                <?php if($districts->isEmpty()): ?>
                    <div class="alert alert-info">
                        <i class="ti-info-alt"></i> No districts found.
                    </div>
                <?php else: ?>
                    <!-- Filters Section -->
                    <div class="row mb-4">
                        ...
                        <table class="table" id="districtsTable">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><?php echo e(number_format($district->population)); ?></td>
                                    <td data-status="<?php echo e($district->is_active ? 'active' : 'inactive'); ?>">
                                ...
                                <td>
                                    <div class="action_btns d-flex">
                                        <a href="<?php echo e(route('districts.show', $district)); ?>" class="action_btn mr_10" title="View">
                                            <i class="ti-eye"></i>
                                        </a>
                                        <a href="<?php echo e(route('districts.edit', $district)); ?>" class="action_btn mr_10" title="Edit">
                                            <i class="ti-pencil"></i>
                                        </a>
                                        <form action="<?php echo e(route('districts.destroy', $district)); ?>" method="POST" class="d-inline mr_10" onsubmit="return confirmDelete(event, 'Are you sure you want to delete this district?')">
                                            <?php echo csrf_field(); ?>
...
<script>
    $(document).ready(function() {
        var table = $('#districtsTable').DataTable({
            ...
            buttons: [
                ...
                },
                {
                    ...
                    className: 'btn btn-sm btn-secondary',
                    filename: 'districts-' + new Date().toISOString().split('T')[0],
                    exportOptions: {
                        columns: [0, 1, 2],
                        format: {
                            body: function(data, row, column, node) {
        ...
        var statusFilter = function(settings, data, dataIndex) {
            ...
            var rowStatus = $(row).find('td:eq(2)').attr('data-status');
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\wheat\wheat\wheat_distribution\zakat_beneficiaries\laravel_project\resources\views/districts/index.blade.php ENDPATH**/ ?>