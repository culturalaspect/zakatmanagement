<?php $__env->startSection('title', config('app.name') . ' - Add Phase'); ?>
<?php $__env->startSection('page_title', 'Add Phase'); ?>
<?php $__env->startSection('breadcrumb', 'Add Phase'); ?>
    ...
    <div class="col-lg-12">
        <div class="white_card mb_30">
            ...
            <div class="white_card_body">
                <form action="<?php echo e(route('phases.store')); ?>" method="POST" id="phaseForm">
                    <?php echo csrf_field(); ?>
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <select name="installment_id" id="installment_id" class="form-control" required>
                                ...
                                <?php $__currentLoopData = $installments; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $installment): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($installment->id); ?>" <?php echo e(old('installment_id') == $installment->id ? 'selected' : ''); ?>

                                        data-financial-year="<?php echo e($installment->fundAllocation->financialYear->name ?? 'N/A'); ?>">
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="number" name="phase_number" id="phase_number" class="form-control" value="<?php echo e(old('phase_number')); ?>" min="1" required>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" name="name" id="phase_name" class="form-control" value="<?php echo e(old('name')); ?>" placeholder="Will be auto-generated">
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="number" name="max_beneficiaries" id="max_beneficiaries" class="form-control" value="<?php echo e(old('max_beneficiaries')); ?>" min="1" required>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="col-md-6 mb-3" id="max_amount_div" style="display: none;">
                            ...
                            <input type="number" name="max_amount" id="max_amount" class="form-control" value="<?php echo e(old('max_amount')); ?>" min="0" step="0.01">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\wheat\wheat\wheat_distribution\zakat_beneficiaries\laravel_project\resources\views/phases/create.blade.php ENDPATH**/ ?>