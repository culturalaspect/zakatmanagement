...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="col-md-6 mb-3" id="max_amount_div" style="display: none;">
                            ...
                            <input type="number" name="max_amount" id="max_amount" class="form-control" value="<?php echo e(old('max_amount', $phase->max_amount)); ?>" min="0" step="0.01">
        ...
        function displayQuotaInfo(data) {
            ...
            if (schemeSelect.val() && currentMaxBeneficiaries > 0) {
                if (isLumpSum) {
                    ...
                    currentMaxAmount = parseFloat('<?php echo e($phase->max_amount ?? 0); ?>') || 0;
                } else {
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\php_projects_new\zakat_beneficiaries\laravel_project\resources\views/phases/edit.blade.php ENDPATH**/ ?>