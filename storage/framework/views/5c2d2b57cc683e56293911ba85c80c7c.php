...
<?php $__env->startSection('title', config('app.name') . ' - All Cases'); ?>
<?php $__env->startSection('page_title', 'All Cases'); ?>
<?php $__env->startSection('breadcrumb', 'All Cases'); ?>
            ...
            <div class="white_card_body">
                ...
                <ul class="nav nav-tabs" id="casesTab" role="tablist">
                    <li class="nav-item" role="presentation">
                        <button class="nav-link active" id="pending-tab" data-bs-toggle="tab" data-bs-target="#pending" type="button" role="tab">
                            Pending Approvals
                            <span class="badge bg-warning badge-count"><?php echo e($pendingBeneficiaries->count()); ?></span>
                        </button>
                    </li>
                    <li class="nav-item" role="presentation">
                        <button class="nav-link" id="approved-tab" data-bs-toggle="tab" data-bs-target="#approved" type="button" role="tab">
                            Approved Cases
                            <span class="badge bg-success badge-count"><?php echo e($approvedBeneficiaries->count()); ?></span>
                        </button>
                    </li>
                    <li class="nav-item" role="presentation">
                        <button class="nav-link" id="rejected-tab" data-bs-toggle="tab" data-bs-target="#rejected" type="button" role="tab">
                            Rejected Cases
                            <span class="badge bg-danger badge-count"><?php echo e($rejectedBeneficiaries->count()); ?></span>
                        </button>
                    </li>
                    <li class="nav-item" role="presentation">
                        <button class="nav-link" id="paid-tab" data-bs-toggle="tab" data-bs-target="#paid" type="button" role="tab">
                            Paid Cases
                            <span class="badge bg-info badge-count"><?php echo e($paidBeneficiaries->count()); ?></span>
                        </button>
                    </li>
                    <li class="nav-item" role="presentation">
                        <button class="nav-link" id="payment-failed-tab" data-bs-toggle="tab" data-bs-target="#payment-failed" type="button" role="tab">
                            ...
                            <span class="badge bg-danger badge-count"><?php echo e($paymentFailedBeneficiaries->count()); ?></span>
                        </button>
                    </li>
                </ul>
                ...
                <div class="tab-content" id="casesTabContent">
                    ...
                    <div class="tab-pane fade show active" id="pending" role="tabpanel">
                        <?php if($pendingBeneficiaries->isEmpty()): ?>
                            <div class="alert alert-info">
                                <i class="ti-info-alt"></i> No pending approvals found.
                            </div>
                        <?php else: ?>
                            <?php echo $__env->make('admin-hq.partials.cases-table', [
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\wheat\wheat\wheat_distribution\zakat_beneficiaries\laravel_project\resources\views/admin-hq/all-cases.blade.php ENDPATH**/ ?>