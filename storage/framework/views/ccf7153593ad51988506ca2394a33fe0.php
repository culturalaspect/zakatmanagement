<?php $__env->startSection('title', config('app.name') . ' - Reports'); ?>
...
<div class="row">
    <div class="col-md-6 col-lg-4 mb-3">
        <a href="<?php echo e(route('reports.executive-summary')); ?>" class="text-decoration-none">
    ...
    <div class="col-md-6 col-lg-4 mb-3">
        <a href="<?php echo e(route('reports.district-wise')); ?>" class="text-decoration-none">
            <div class="card h-100 shadow-sm card-hover-shadow-2x">
                <div class="card-body d-flex align-items-center">
                    <div class="icon-wrapper rounded-circle me-3">
    ...
    <div class="col-md-6 col-lg-4 mb-3">
        <a href="<?php echo e(route('reports.scheme-wise')); ?>" class="text-decoration-none">
            <div class="card h-100 shadow-sm card-hover-shadow-2x">
                <div class="card-body d-flex align-items-center">
                    <div class="icon-wrapper rounded-circle me-3">
    ...
    <div class="col-md-6 col-lg-4 mb-3">
        <a href="<?php echo e(route('reports.beneficiary-status')); ?>" class="text-decoration-none">
            <div class="card h-100 shadow-sm card-hover-shadow-2x">
                <div class="card-body d-flex align-items-center">
                    <div class="icon-wrapper rounded-circle me-3">
    ...
    <div class="col-md-6 col-lg-4 mb-3">
        <a href="<?php echo e(route('reports.phase-wise')); ?>" class="text-decoration-none">
            <div class="card h-100 shadow-sm card-hover-shadow-2x">
                <div class="card-body d-flex align-items-center">
                    <div class="icon-wrapper rounded-circle me-3">
    ...
    <div class="col-md-6 col-lg-4 mb-3">
        <a href="<?php echo e(route('reports.fund-disbursement')); ?>" class="text-decoration-none">
            <div class="card h-100 shadow-sm card-hover-shadow-2x">
                <div class="card-body d-flex align-items-center">
                    <div class="icon-wrapper rounded-circle me-3">
    ...
    <div class="col-md-6 col-lg-4 mb-3">
        <a href="<?php echo e(route('reports.financial-year-summary')); ?>" class="text-decoration-none">
            <div class="card h-100 shadow-sm card-hover-shadow-2x">
                <div class="card-body d-flex align-items-center">
                    <div class="icon-wrapper rounded-circle me-3">
                        <div class="icon-wrapper-bg bg-primary"></div>
    ...
    <div class="col-md-6 col-lg-4 mb-3">
        <a href="<?php echo e(route('reports.lzc-wise')); ?>" class="text-decoration-none">
            <div class="card h-100 shadow-sm card-hover-shadow-2x">
                <div class="card-body d-flex align-items-center">
                    <div class="icon-wrapper rounded-circle me-3">
                        <div class="icon-wrapper-bg bg-success"></div>
    ...
    <div class="col-md-6 col-lg-4 mb-3">
        <a href="<?php echo e(route('reports.institution-wise')); ?>" class="text-decoration-none">
            <div class="card h-100 shadow-sm card-hover-shadow-2x">
                <div class="card-body d-flex align-items-center">
                    <div class="icon-wrapper rounded-circle me-3">
                        <div class="icon-wrapper-bg bg-info"></div>
    ...
    <div class="col-md-6 col-lg-4 mb-3">
        <a href="<?php echo e(route('reports.payment-report')); ?>" class="text-decoration-none">
            <div class="card h-100 shadow-sm card-hover-shadow-2x">
                <div class="card-body d-flex align-items-center">
                    <div class="icon-wrapper rounded-circle me-3">
                        <div class="icon-wrapper-bg bg-warning"></div>
    ...
    <div class="col-md-6 col-lg-4 mb-3">
        <a href="<?php echo e(route('reports.beneficiary-list')); ?>" class="text-decoration-none">
            <div class="card h-100 shadow-sm card-hover-shadow-2x">
                <div class="card-body d-flex align-items-center">
                    <div class="icon-wrapper rounded-circle me-3">
                        <div class="icon-wrapper-bg bg-secondary"></div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\php_projects_new\zakat_beneficiaries\laravel_project\resources\views/reports/index.blade.php ENDPATH**/ ?>