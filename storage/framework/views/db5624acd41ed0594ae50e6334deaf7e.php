<?php $__env->startSection('title', config('app.name') . ' - Edit LZC Member'); ?>
<?php $__env->startSection('page_title', 'Edit LZC Member'); ?>
<?php $__env->startSection('breadcrumb', 'Edit LZC Member'); ?>
    ...
    <div class="col-lg-12">
        <div class="white_card mb_30">
            ...
            <div class="white_card_body">
                ...
                <?php endif; ?>
                <form action="<?php echo e(route('lzc-members.update', $lZCMember)); ?>" method="POST">
                    <?php echo csrf_field(); ?>
                            ...
                            <div class="row">
                                <div class="col-md-6 mb-3">
                                    ...
                                    <select id="filterDistrict" class="form-control">
                                        ...
                                        <option value="<?php echo e($district->id); ?>" <?php echo e(($lZCMember->localZakatCommittee && $lZCMember->localZakatCommittee->district_id == $district->id) ? 'selected' : ''); ?>><?php echo e($district->name); ?></option>
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <select name="local_zakat_committee_id" id="local_zakat_committee_id" class="form-control" required>
                                        ...
                                        <option value="<?php echo e($committee->id); ?>" data-district-id="<?php echo e($committee->district_id); ?>" <?php echo e(old('local_zakat_committee_id', $lZCMember->local_zakat_committee_id) == $committee->id ? 'selected' : ''); ?>>
                    ...
                    <div class="card mb-4">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <div class="input-group">
                                <input type="text" name="cnic" id="cnic" class="form-control" value="<?php echo e(old('cnic', $lZCMember->cnic)); ?>" placeholder="12345-1234567-1" maxlength="15" pattern="[0-9]{5}-[0-9]{7}-[0-9]{1}" required <?php echo e($lZCMember->verification_status == 'verified' ? 'readonly' : ''); ?>>
                                <?php if($lZCMember->verification_status != 'verified'): ?>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <div class="position-relative">
                                <input type="text" name="full_name" id="full_name" class="form-control" value="<?php echo e(old('full_name', $lZCMember->full_name)); ?>" required <?php echo e($lZCMember->verification_status == 'verified' ? 'readonly' : ''); ?>>
                                <?php if($lZCMember->verification_status != 'verified'): ?>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <div class="position-relative">
                                <input type="text" name="father_husband_name" id="father_husband_name" class="form-control" value="<?php echo e(old('father_husband_name', $lZCMember->father_husband_name)); ?>" required <?php echo e($lZCMember->verification_status == 'verified' ? 'readonly' : ''); ?>>
                                <?php if($lZCMember->verification_status != 'verified'): ?>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <div class="position-relative">
                                <input type="text" name="mobile_number" id="mobile_number" class="form-control" value="<?php echo e(old('mobile_number', $lZCMember->mobile_number)); ?>" placeholder="03XX-XXXXXXX" maxlength="12" pattern="03[0-9]{2}-[0-9]{7}" <?php echo e($lZCMember->verification_status == 'verified' ? 'readonly' : ''); ?>>
                                <?php if($lZCMember->verification_status != 'verified'): ?>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <div class="position-relative">
                                <input type="date" name="date_of_birth" id="date_of_birth" class="form-control" value="<?php echo e(old('date_of_birth', $lZCMember->date_of_birth ? \Carbon\Carbon::parse($lZCMember->date_of_birth)->format('Y-m-d') : '')); ?>" required <?php echo e($lZCMember->verification_status == 'verified' ? 'readonly' : ''); ?>>
                                <?php if($lZCMember->verification_status != 'verified'): ?>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <div class="position-relative">
                                <select name="gender" id="gender" class="form-control" required <?php echo e($lZCMember->verification_status == 'verified' ? 'disabled' : ''); ?>>
                                    <option value="">Select Gender</option>
                                    <option value="male" <?php echo e(old('gender', $lZCMember->gender) == 'male' ? 'selected' : ''); ?>>Male</option>
                                    <option value="female" <?php echo e(old('gender', $lZCMember->gender) == 'female' ? 'selected' : ''); ?>>Female</option>
                                    <option value="other" <?php echo e(old('gender', $lZCMember->gender) == 'other' ? 'selected' : ''); ?>>Other</option>
                                </select>
                                <?php if($lZCMember->verification_status != 'verified'): ?>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" name="designation" id="designation" class="form-control" value="<?php echo e(old('designation', $lZCMember->designation)); ?>" placeholder="e.g., Chairman, Secretary, Member" required <?php echo e($lZCMember->verification_status == 'verified' ? 'readonly' : ''); ?>>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="date" name="start_date" class="form-control" value="<?php echo e(old('start_date', $lZCMember->start_date ? \Carbon\Carbon::parse($lZCMember->start_date)->format('Y-m-d') : '')); ?>" required>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="date" name="end_date" class="form-control" value="<?php echo e(old('end_date', $lZCMember->end_date ? \Carbon\Carbon::parse($lZCMember->end_date)->format('Y-m-d') : '')); ?>">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\php_projects_new\zakat_beneficiaries\laravel_project\resources\views/lzc-members/edit.blade.php ENDPATH**/ ?>