...
<?php $__env->startSection('title', config('app.name') . ' - Union Councils'); ?>
<?php $__env->startSection('page_title', 'Union Councils'); ?>
<?php $__env->startSection('breadcrumb', 'Union Councils'); ?>
            ...
            <div class="white_card_header">
                <div class="box_header m-0">
                    ...
                    <div class="header_more_tool">
                        <a href="<?php echo e(route('union-councils.create')); ?>" class="btn btn-primary">
                ...
                <?php else: ?>
                    ...
                    <div class="table-responsive">
                        <table class="table" id="unionCouncilsTable">
                            ...
                            <tbody>
                                <?php $__empty_1 = true; $__currentLoopData = $unionCouncils; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $unionCouncil): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                <tr>
                                    <td><?php echo e($unionCouncil->name); ?></td>
                                    <td data-tehsil="<?php echo e($unionCouncil->tehsil->name ?? ''); ?>"><?php echo e($unionCouncil->tehsil->name ?? 'N/A'); ?></td>
                                    <td data-district="<?php echo e($unionCouncil->tehsil->district->name ?? ''); ?>"><?php echo e($unionCouncil->tehsil->district->name ?? 'N/A'); ?></td>
                                    <td><?php echo e($unionCouncil->villages->count() ?? 0); ?></td>
                                    <td data-status="<?php echo e($unionCouncil->is_active ? 'active' : 'inactive'); ?>">
                                    ...
                                    <td>
                                        <div class="action_btns d-flex">
                                            <a href="<?php echo e(route('union-councils.show', $unionCouncil)); ?>" class="action_btn mr_10" title="View">
                                                <i class="ti-eye"></i>
                                            </a>
                                            <a href="<?php echo e(route('union-councils.edit', $unionCouncil)); ?>" class="action_btn mr_10" title="Edit">
                                                <i class="ti-pencil"></i>
                                            </a>
                                            <form action="<?php echo e(route('union-councils.destroy', $unionCouncil)); ?>" method="POST" class="d-inline mr_10" onsubmit="return confirmDelete(event, 'Are you sure you want to delete this union council?')">
                                                <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\php_projects_new\zakat_beneficiaries\laravel_project\resources\views/union-councils/index.blade.php ENDPATH**/ ?>