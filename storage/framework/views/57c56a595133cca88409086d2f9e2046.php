<?php $__env->startSection('title', config('app.name') . ' - Phase Details'); ?>
<?php $__env->startSection('page_title', 'Phase Details'); ?>
<?php $__env->startSection('breadcrumb', 'Phase Details'); ?>
        ...
        <div class="white_card mb_30">
            <div class="white_card_header">
                <div class="box_header m-0">
                    ...
                    <div class="header_more_tool">
                        ...
                        <a href="<?php echo e(route('phases.edit', $phase)); ?>" class="btn btn-primary">
                            <i class="ti-pencil"></i> Edit Phase
                        </a>
                        <form action="<?php echo e(route('phases.destroy', $phase)); ?>" method="POST" class="d-inline" onsubmit="return confirmDelete(event, 'Are you sure you want to delete this phase?')">
                            <?php echo csrf_field(); ?>
            ...
            <div class="white_card_body">
                ...
                <div class="d-flex justify-content-between align-items-center mb-3">
                    <h5 class="mb-0">Beneficiaries (<span id="beneficiariesCount"><?php echo e($phase->beneficiaries->count() ?? 0); ?></span>)</h5>
                ...
                <div id="beneficiariesTableContainer">
                    <?php if($phase->beneficiaries && $phase->beneficiaries->count() > 0): ?>
                    <!-- Filters Section -->
                    <div class="row mb-4">
                        <div class="col-12">
                    ...
                    <div class="table-responsive">
                        <table class="table" id="beneficiariesTable">
                            ...
                            <tbody id="beneficiariesTableBody">
                                <?php $__currentLoopData = $phase->beneficiaries; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $beneficiary): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\php_projects_new\zakat_beneficiaries\laravel_project\resources\views/phases/show.blade.php ENDPATH**/ ?>