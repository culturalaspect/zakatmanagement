...
<head>
    ...
    <title><?php echo $__env->yieldContent('title', config('app.name', 'Zakat Beneficiaries')); ?></title>
...
<body class="crm_body_bg">
    ...
    <nav class="sidebar">
        <div class="logo d-flex justify-content-between">
            <a style="margin-left:auto;margin-right:auto;" class="large_logo" href="<?php echo e(route('dashboard')); ?>"><img style="max-width:60px;" src="<?php echo e(asset('img/logo.png')); ?>" alt=""></a>
        ...
        <ul id="sidebar_menu">
            <li class="<?php echo e(request()->routeIs('dashboard') ? 'active' : ''); ?>">
                <a href="<?php echo e(route('dashboard')); ?>" class="<?php echo e(request()->routeIs('dashboard') ? 'active' : ''); ?>" aria-expanded="false">
            ...
            <li class="<?php echo e(request()->routeIs('zakat-council-members.*') ? 'active' : ''); ?>">
                <a href="<?php echo e(route('zakat-council-members.index')); ?>" class="<?php echo e(request()->routeIs('zakat-council-members.*') ? 'active' : ''); ?>" aria-expanded="false">
                    <div class="nav_icon_small">
                        <i class="ti-user"></i>
                    </div>
                    <div class="nav_title">
            ...
            <li class="<?php echo e(request()->routeIs('districts.*') ? 'active' : ''); ?>">
                <a href="<?php echo e(route('districts.index')); ?>" class="<?php echo e(request()->routeIs('districts.*') ? 'active' : ''); ?>" aria-expanded="false">
                    <div class="nav_icon_small">
                        <i class="ti-map"></i>
                    </div>
                    <div class="nav_title">
            ...
            <li class="<?php echo e(request()->routeIs('tehsils.*') ? 'active' : ''); ?>">
                <a href="<?php echo e(route('tehsils.index')); ?>" class="<?php echo e(request()->routeIs('tehsils.*') ? 'active' : ''); ?>" aria-expanded="false">
                    <div class="nav_icon_small">
            ...
            <li class="<?php echo e(request()->routeIs('union-councils.*') ? 'active' : ''); ?>">
                <a href="<?php echo e(route('union-councils.index')); ?>" class="<?php echo e(request()->routeIs('union-councils.*') ? 'active' : ''); ?>" aria-expanded="false">
                    <div class="nav_icon_small">
            ...
            <li class="<?php echo e(request()->routeIs('villages.*') ? 'active' : ''); ?>">
                <a href="<?php echo e(route('villages.index')); ?>" class="<?php echo e(request()->routeIs('villages.*') ? 'active' : ''); ?>" aria-expanded="false">
                    <div class="nav_icon_small">
                        <i class="ti-home"></i>
                    </div>
                    <div class="nav_title">
            ...
            <li class="<?php echo e(request()->routeIs('mohallas.*') ? 'active' : ''); ?>">
                <a href="<?php echo e(route('mohallas.index')); ?>" class="<?php echo e(request()->routeIs('mohallas.*') ? 'active' : ''); ?>" aria-expanded="false">
                    <div class="nav_icon_small">
                        <i class="ti-pin"></i>
                    </div>
                    <div class="nav_title">
            ...
            <li class="<?php echo e(request()->routeIs('schemes.*') ? 'active' : ''); ?>">
                <a href="<?php echo e(route('schemes.index')); ?>" class="<?php echo e(request()->routeIs('schemes.*') ? 'active' : ''); ?>" aria-expanded="false">
                    <div class="nav_icon_small">
                        <i class="ti-list"></i>
                    </div>
                    <div class="nav_title">
            ...
            <li class="<?php echo e(request()->routeIs('financial-years.*') ? 'active' : ''); ?>">
                <a href="<?php echo e(route('financial-years.index')); ?>" class="<?php echo e(request()->routeIs('financial-years.*') ? 'active' : ''); ?>" aria-expanded="false">
                    <div class="nav_icon_small">
            ...
            <li class="<?php echo e(request()->routeIs('fund-allocations.*') ? 'active' : ''); ?>">
                <a href="<?php echo e(route('fund-allocations.index')); ?>" class="<?php echo e(request()->routeIs('fund-allocations.*') ? 'active' : ''); ?>" aria-expanded="false">
                    <div class="nav_icon_small">
                        <i class="ti-money"></i>
                    </div>
                    <div class="nav_title">
            ...
            <li class="<?php echo e(request()->routeIs('users.*') ? 'active' : ''); ?>">
                <a href="<?php echo e(route('users.index')); ?>" class="<?php echo e(request()->routeIs('users.*') ? 'active' : ''); ?>" aria-expanded="false">
                    <div class="nav_icon_small">
                        <i class="ti-user"></i>
                    </div>
                    <div class="nav_title">
            ...
            <?php if(!auth()->user()->isDistrictUser() && !auth()->user()->isInstitutionUser()): ?>
            <h4 class="menu-text"><span>COMMITTEES</span> <i class="fas fa-ellipsis-h"></i> </h4>
            <li class="<?php echo e(request()->routeIs('local-zakat-committees.*') ? 'active' : ''); ?>">
                <a href="<?php echo e(route('local-zakat-committees.index')); ?>" class="<?php echo e(request()->routeIs('local-zakat-committees.*') ? 'active' : ''); ?>" aria-expanded="false">
                    <div class="nav_icon_small">
            ...
            <li class="<?php echo e(request()->routeIs('lzc-members.*') ? 'active' : ''); ?>">
                <a href="<?php echo e(route('lzc-members.index')); ?>" class="<?php echo e(request()->routeIs('lzc-members.*') ? 'active' : ''); ?>" aria-expanded="false">
                    <div class="nav_icon_small">
                        <i class="ti-user"></i>
                    </div>
                    <div class="nav_title">
            ...
            <li class="<?php echo e(request()->routeIs('institutions.*') ? 'active' : ''); ?>">
                <a href="<?php echo e(route('institutions.index')); ?>" class="<?php echo e(request()->routeIs('institutions.*') ? 'active' : ''); ?>" aria-expanded="false">
                    <div class="nav_icon_small">
                        <i class="ti-home"></i>
                    </div>
                    <div class="nav_title">
            ...
            <?php if(!auth()->user()->isDistrictUser() && !auth()->user()->isInstitutionUser()): ?>
            <li class="<?php echo e(request()->routeIs('phases.*') ? 'active' : ''); ?>">
                <a href="<?php echo e(route('phases.index')); ?>" class="<?php echo e(request()->routeIs('phases.*') ? 'active' : ''); ?>" aria-expanded="false">
                    <div class="nav_icon_small">
                        <i class="ti-calendar"></i>
                    </div>
                    <div class="nav_title">
            ...
            <?php endif; ?>
            <li class="<?php echo e(request()->routeIs('beneficiary-applications.*') ? 'active' : ''); ?>">
                <a href="<?php echo e(route('beneficiary-applications.index')); ?>" class="<?php echo e(request()->routeIs('beneficiary-applications.*') ? 'active' : ''); ?>" aria-expanded="false">
                    <div class="nav_icon_small">
                        <i class="ti-file"></i>
                    </div>
                    <div class="nav_title">
            ...
            <li class="<?php echo e(request()->routeIs('beneficiaries.*') ? 'active' : ''); ?>">
                <a href="<?php echo e(route('beneficiaries.index')); ?>" class="<?php echo e(request()->routeIs('beneficiaries.*') ? 'active' : ''); ?>" aria-expanded="false">
                    <div class="nav_icon_small">
            ...
            <li class="<?php echo e(request()->routeIs('jazzcash-response.*') ? 'active' : ''); ?>">
                <a href="<?php echo e(route('jazzcash-response.index')); ?>" class="<?php echo e(request()->routeIs('jazzcash-response.*') ? 'active' : ''); ?>" aria-expanded="false">
                    <div class="nav_icon_small">
                        <i class="ti-upload"></i>
                    </div>
                    <div class="nav_title">
            ...
            <?php if(auth()->user()->isAdministratorHQ() || auth()->user()->isSuperAdmin() || auth()->user()->isDistrictUser()): ?>
            <li class="<?php echo e(request()->routeIs('admin-hq.all-cases') || request()->routeIs('admin-hq.pending') || request()->routeIs('admin-hq.approved-cases') || request()->routeIs('admin-hq.rejected-cases') || request()->routeIs('admin-hq.show-*') ? 'active' : ''); ?>">
                <a href="<?php echo e(route('admin-hq.all-cases')); ?>" class="<?php echo e(request()->routeIs('admin-hq.all-cases') || request()->routeIs('admin-hq.pending') || request()->routeIs('admin-hq.approved-cases') || request()->routeIs('admin-hq.rejected-cases') || request()->routeIs('admin-hq.show-*') ? 'active' : ''); ?>" aria-expanded="false">
                    <div class="nav_icon_small">
                        <i class="ti-files"></i>
                    </div>
                    <div class="nav_title">
            ...
            <li class="<?php echo e(request()->routeIs('reports.*') ? 'active' : ''); ?>">
                <a href="<?php echo e(route('reports.index')); ?>" class="<?php echo e(request()->routeIs('reports.*') ? 'active' : ''); ?>" aria-expanded="false">
                    <div class="nav_icon_small">
                    ...
                    <div class="header_iner d-flex justify-content-between align-items-center">
                        ...
                        <div class="header_right d-flex justify-content-between align-items-center">
                                    ...
                                    <div class="Menu_NOtification_Wrap">
                                        ...
                                        <div class="Notification_body">
                                            <?php if(auth()->check()): ?>
                                                ...
                                                <div class="single_notify d-flex align-items-center <?php echo e(!$notification->is_read ? 'unread-notification' : ''); ?>" style="cursor: pointer; <?php echo e(!$notification->is_read ? 'background-color: #fff3cd;' : ''); ?>" onclick="window.location.href='<?php echo e(route('notifications.show', $notification)); ?>'">
                                                    <div class="notify_thumb">
                                                        <a href="<?php echo e(route('notifications.show', $notification)); ?>" onclick="event.stopPropagation();"><img src="<?php echo e(asset('assets/img/staf/2.png')); ?>" alt=""></a>
                                                    </div>
                                                    <div class="notify_content">
                                                        <a href="<?php echo e(route('notifications.show', $notification)); ?>" onclick="event.stopPropagation();"><h5><?php echo e($notification->title); ?> <?php if(!$notification->is_read): ?><span class="badge bg-danger" style="font-size: 0.7em;">New</span><?php endif; ?></h5></a>
                                                        <p><?php echo e(\Illuminate\Support\Str::limit($notification->message, 60)); ?></p>
                                        ...
                                        <div class="nofity_footer">
                                            <div class="submit_button text-center pt_20">
                                                <a href="<?php echo e(route('notifications.index')); ?>" class="btn_1">See More</a>
                                            </div>
                                        </div>
                                    </div>
                                    <!--/ Menu_NOtification_Wrap  -->
                            ...
                            <div class="profile_info">
                                ...
                                ?>
                                <?php if($hasImage): ?>
                                    <img src="<?php echo e(asset('storage/' . $user->image)); ?>" alt="<?php echo e($user->name); ?>" style="width: 50px; height: 50px; border-radius: 50%; object-fit: cover;">
                                <?php else: ?>
                                ...
                                <div class="profile_info_iner">
                                    <div class="profile_author_name">
                                        <p><?php echo e(auth()->user()->role == 'super_admin' ? 'Super Admin' : (auth()->user()->role == 'administrator_hq' ? 'Administrator HQ' : 'District User')); ?></p>
                                        <h5><?php echo e(auth()->user()->name); ?></h5>
                                    </div>
                                    <div class="profile_info_details">
                                        <a href="<?php echo e(route('profile.show')); ?>">My Profile</a>
                                        <a href="<?php echo e(route('settings.show')); ?>">Settings</a>
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-6">
                                    <div class="dashboard_breadcam text-end">
                                        <p><a href="<?php echo e(route('dashboard')); ?>">Home</a> <i class="fas fa-caret-right"></i> <?php echo $__env->yieldContent('breadcrumb', 'Dashboard'); ?></p>
                                    </div>
                                </div>
                            </div>
                        </div>
...
<div class="footer_part">
            <div class="container-fluid">
                ...
                <div class="footer_iner text-center">
                            <p>Powered By <a href="https://gbit.gov.pk" target="_blank">Information Technology Department GB</a> © <?php echo e(date('Y')); ?> All Rights Reserved</p>
                </div>
                </div>
            </div>
        </div>
...
<?php /**PATH D:\php_projects_new\zakat_beneficiaries\laravel_project\resources\views/layouts/app.blade.php ENDPATH**/ ?>