                                        ...
                                        <div class="col-md-4 mb-3">
                                            ...
                                            <select id="filterTehsil" class="form-control form-control-sm">
                                                ...
                                                <?php $__currentLoopData = $tehsils; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tehsil): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <option value="<?php echo e($tehsil->name); ?>"><?php echo e($tehsil->name); ?> (<?php echo e($tehsil->district->name ?? ''); ?>)</option>
                        ...
                        <table class="table" id="unionCouncilsTable">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><?php echo e($unionCouncil->tehsil->district->name ?? 'N/A'); ?></td>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\wheat\wheat\wheat_distribution\zakat_beneficiaries\laravel_project\resources\views/union-councils/index.blade.php ENDPATH**/ ?>