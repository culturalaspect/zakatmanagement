...
<?php $__env->startSection('title', config('app.name') . ' - Rejected Case Details'); ?>
<?php $__env->startSection('page_title', 'Rejected Case Details'); ?>
<?php $__env->startSection('breadcrumb', 'Rejected Case Details'); ?>
    ...
    <div class="col-lg-12">
        <div class="white_card mb_30">
            <div class="white_card_header">
                <div class="box_header m-0">
                    ...
                    <div class="header_more_tool">
                        <a href="<?php echo e(route('admin-hq.all-cases')); ?>?tab=rejected" class="btn btn-secondary">
            ...
            <div class="white_card_body">
                ...
                <?php if($beneficiary->admin_remarks || $beneficiary->district_remarks || $beneficiary->rejection_remarks): ?>
                <hr class="my-4">
                <div class="row">
                    <div class="col-md-12 mb-4">
                    ...
                    <div class="col-md-12 mb-3">
                        ...
                        <p class="mb-0 text-danger"><strong><?php echo e($beneficiary->admin_remarks); ?></strong></p>
                    </div>
                    <?php endif; ?>
                ...
                <div class="row">
                    ...
                    <?php endif; ?>
                    <?php if($beneficiary->rejected_at): ?>
                    <div class="col-md-6 mb-3">
                        <strong>Rejected At:</strong>
                        <p class="mb-0"><?php echo e($beneficiary->rejected_at->format('d M Y H:i:s')); ?></p>
                    </div>
                    <?php endif; ?>
                    <div class="col-md-6 mb-3">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\wheat\wheat\wheat_distribution\zakat_beneficiaries\laravel_project\resources\views/admin-hq/show-rejected-case.blade.php ENDPATH**/ ?>