...
<?php $__env->startSection('title', config('app.name') . ' - Zakat Council Members'); ?>
<?php $__env->startSection('page_title', 'Zakat Council Members'); ?>
<?php $__env->startSection('breadcrumb', 'Zakat Council Members'); ?>
            ...
            <div class="white_card_header">
                <div class="box_header m-0">
                    ...
                    <div class="header_more_tool">
                        <a href="<?php echo e(route('zakat-council-members.create')); ?>" class="btn btn-primary">
                        ...
                        <table class="table" id="membersTable">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><?php echo e($member->role_in_committee); ?></td>
                                    <td><?php echo e($member->start_date->format('Y-m-d')); ?></td>
                                    <td><?php echo e($member->end_date ? $member->end_date->format('Y-m-d') : 'Current'); ?></td>
                                ...
                                <td>
                                    <div class="action_btns d-flex">
                                        <a href="<?php echo e(route('zakat-council-members.show', $member)); ?>" class="action_btn mr_10" title="View">
                                            <i class="ti-eye"></i>
                                        </a>
                                        <a href="<?php echo e(route('zakat-council-members.edit', $member)); ?>" class="action_btn mr_10" title="Edit">
                                            <i class="ti-pencil"></i>
                                        </a>
                                        <form action="<?php echo e(route('zakat-council-members.destroy', $member)); ?>" method="POST" class="d-inline mr_10" onsubmit="return confirmDelete(event, 'Are you sure you want to delete this member?')">
                                            <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\wheat\wheat\wheat_distribution\zakat_beneficiaries\laravel_project\resources\views/zakat-council-members/index.blade.php ENDPATH**/ ?>