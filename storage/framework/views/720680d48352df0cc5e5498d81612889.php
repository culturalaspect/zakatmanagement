...
<?php $__env->startSection('title', config('app.name') . ' - Mohallas'); ?>
<?php $__env->startSection('page_title', 'Mohallas'); ?>
<?php $__env->startSection('breadcrumb', 'Mohallas'); ?>
            ...
            <div class="white_card_header">
                <div class="box_header m-0">
                    ...
                    <div class="header_more_tool">
                        <a href="<?php echo e(route('mohallas.create')); ?>" class="btn btn-primary">
                ...
                <?php else: ?>
                                        ...
                                        <div class="col-md-3 mb-3">
                                            ...
                                            <select id="filterTehsil" class="form-control form-control-sm">
                                                ...
                                                <?php $__currentLoopData = $tehsils; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tehsil): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <option value="<?php echo e($tehsil->name); ?>" data-district-id="<?php echo e($tehsil->district_id); ?>"><?php echo e($tehsil->name); ?> (<?php echo e($tehsil->district->name ?? ''); ?>)</option>
                                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                            </select>
                                        </div>
                                        <div class="col-md-3 mb-3">
                                            ...
                                            <select id="filterUnionCouncil" class="form-control form-control-sm">
                                                ...
                                                <?php $__currentLoopData = $unionCouncils; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $uc): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <option value="<?php echo e($uc->name); ?>" data-tehsil-id="<?php echo e($uc->tehsil_id); ?>"><?php echo e($uc->name); ?> (<?php echo e($uc->tehsil->name ?? ''); ?>)</option>
                                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                            </select>
                                        </div>
                                        <div class="col-md-3 mb-3">
                                            ...
                                            <select id="filterVillage" class="form-control form-control-sm">
                                                ...
                                                <?php $__currentLoopData = $villages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $village): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <option value="<?php echo e($village->name); ?>" data-union-council-id="<?php echo e($village->union_council_id); ?>"><?php echo e($village->name); ?> (<?php echo e($village->unionCouncil->tehsil->district->name ?? ''); ?>)</option>
                                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                            </select>
                                        </div>
                                    </div>
                    ...
                    <div class="table-responsive">
                        <table class="table" id="mohallasTable">
                            ...
                            <tbody>
                                <?php $__empty_1 = true; $__currentLoopData = $mohallas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $mohalla): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                <tr>
                                    <td><?php echo e($mohalla->name); ?></td>
                                    <td data-village="<?php echo e($mohalla->village->name ?? ''); ?>"><?php echo e($mohalla->village->name ?? 'N/A'); ?></td>
                                    <td data-union-council="<?php echo e($mohalla->village->unionCouncil->name ?? ''); ?>"><?php echo e($mohalla->village->unionCouncil->name ?? 'N/A'); ?></td>
                                    <td data-tehsil="<?php echo e($mohalla->village->unionCouncil->tehsil->name ?? ''); ?>"><?php echo e($mohalla->village->unionCouncil->tehsil->name ?? 'N/A'); ?></td>
                                    <td data-district="<?php echo e($mohalla->village->unionCouncil->tehsil->district->name ?? ''); ?>"><?php echo e($mohalla->village->unionCouncil->tehsil->district->name ?? 'N/A'); ?></td>
                                    <td data-status="<?php echo e($mohalla->is_active ? 'active' : 'inactive'); ?>">
                                        <?php if($mohalla->is_active): ?>
                                    ...
                                    <td>
                                        <div class="action_btns d-flex">
                                            <a href="<?php echo e(route('mohallas.show', $mohalla)); ?>" class="action_btn mr_10" title="View">
                                                <i class="ti-eye"></i>
                                            </a>
                                            <a href="<?php echo e(route('mohallas.edit', $mohalla)); ?>" class="action_btn mr_10" title="Edit">
                                                <i class="ti-pencil"></i>
                                            </a>
                                            <form action="<?php echo e(route('mohallas.destroy', $mohalla)); ?>" method="POST" class="d-inline mr_10" onsubmit="return confirmDelete(event, 'Are you sure you want to delete this mohalla?')">
                                                <?php echo csrf_field(); ?>
...
<script>
    $(document).ready(function() {
        ...
        $('#filterDistrict').on('change', function() {
            ...
            if (districtId) {
                $('#filterTehsil option').not('[value=""]').not('[data-district-id="' + districtId + '"]').hide();
            }
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\php_projects_new\zakat_beneficiaries\laravel_project\resources\views/mohallas/index.blade.php ENDPATH**/ ?>