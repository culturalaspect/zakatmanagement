...
<?php $__env->startSection('title', config('app.name') . ' - Payment Failed Case Details'); ?>
<?php $__env->startSection('page_title', 'Payment Failed Case Details'); ?>
<?php $__env->startSection('breadcrumb', 'Payment Failed Case Details'); ?>
            ...
            <div class="white_card_header">
                <div class="box_header m-0">
                    ...
                    <div class="header_more_tool">
                        <a href="<?php echo e(route('admin-hq.all-cases')); ?>#payment-failed" class="btn btn-secondary">
            ...
            <div class="white_card_body">
                <div class="row">
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <p class="mb-0"><span class="badge bg-danger"><?php echo e($beneficiary->jazzcash_status ?? 'N/A'); ?></span></p>
                    </div>
                    <div class="col-md-6 mb-3">
                        <strong>Failure Reason:</strong>
                        <p class="mb-0 text-danger"><?php echo e($beneficiary->jazzcash_reason ?? 'N/A'); ?></p>
                    </div>
                    <div class="col-md-6 mb-3">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\wheat\wheat\wheat_distribution\zakat_beneficiaries\laravel_project\resources\views/admin-hq/show-payment-failed-case.blade.php ENDPATH**/ ?>