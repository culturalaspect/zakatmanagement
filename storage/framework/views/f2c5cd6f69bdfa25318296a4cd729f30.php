...
<head>
    ...
    <link rel="stylesheet" href="<?php echo e(asset('assets/css/colors/default.css')); ?>" />
    <style>
        .login-page-wrapper {
            min-height: 100vh;
            display: flex;
            ...
            <div class="login-card">
                <div class="login-header">
                    <div class="login-logo">
                        <img src="<?php echo e(asset('img/gbdoelogo_white.png')); ?>" alt="Zakat Beneficiaries Logo">
                    </div>
                    <h4>Welcome Back</h4>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="footer-login">
                        <p>Powered By <a href="https://gbit.gov.pk" target="_blank" style="color: #667eea; text-decoration: none;">Information Technology Department GB</a> © <?php echo e(date('Y')); ?> All Rights Reserved</p>
                    </div>
                </div>
            </div>
        </div>
    ...
    <script src="<?php echo e(asset('assets/vendors/metismenu/metisMenu.min.js')); ?>"></script>
    <script src="<?php echo e(asset('assets/js/custom.js')); ?>"></script>
</body>
</html>
<?php /**PATH D:\wheat\wheat\wheat_distribution\zakat_beneficiaries\laravel_project\resources\views/auth/login.blade.php ENDPATH**/ ?>