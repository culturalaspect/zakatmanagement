...
<?php $__env->startSection('title', config('app.name') . ' - Tehsils'); ?>
<?php $__env->startSection('page_title', 'Tehsils'); ?>
<?php $__env->startSection('breadcrumb', 'Tehsils'); ?>
            ...
            <div class="white_card_header">
                <div class="box_header m-0">
                    ...
                    <div class="header_more_tool">
                        <a href="<?php echo e(route('tehsils.create')); ?>" class="btn btn-primary">
                ...
                <?php else: ?>
                    ...
                    <div class="table-responsive">
                        <table class="table" id="tehsilsTable">
                            ...
                            <tbody>
                                <?php $__empty_1 = true; $__currentLoopData = $tehsils; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tehsil): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                <tr>
                                    <td><?php echo e($tehsil->name); ?></td>
                                    <td><?php echo e($tehsil->district->name ?? 'N/A'); ?></td>
                                    <td><?php echo e($tehsil->unionCouncils->count() ?? 0); ?></td>
                                    <td data-status="<?php echo e($tehsil->is_active ? 'active' : 'inactive'); ?>">
                                        <?php if($tehsil->is_active): ?>
                                    ...
                                    <td>
                                        <div class="action_btns d-flex">
                                            <a href="<?php echo e(route('tehsils.show', $tehsil)); ?>" class="action_btn mr_10" title="View">
                                                <i class="ti-eye"></i>
                                            </a>
                                            <a href="<?php echo e(route('tehsils.edit', $tehsil)); ?>" class="action_btn mr_10" title="Edit">
                                                <i class="ti-pencil"></i>
                                            </a>
                                            <form action="<?php echo e(route('tehsils.destroy', $tehsil)); ?>" method="POST" class="d-inline mr_10" onsubmit="return confirmDelete(event, 'Are you sure you want to delete this tehsil?')">
                                                <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\wheat\wheat\wheat_distribution\zakat_beneficiaries\laravel_project\resources\views/tehsils/index.blade.php ENDPATH**/ ?>