                                        ...
                                        <div class="col-md-4 mb-3">
                                            ...
                                            <select id="filterVillage" class="form-control form-control-sm">
                                                ...
                                                <?php $__currentLoopData = $villages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $village): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <option value="<?php echo e($village->name); ?>"><?php echo e($village->name); ?> (<?php echo e($village->unionCouncil->tehsil->district->name ?? ''); ?>)</option>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\wheat\wheat\wheat_distribution\zakat_beneficiaries\laravel_project\resources\views/mohallas/index.blade.php ENDPATH**/ ?>