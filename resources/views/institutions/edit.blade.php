...
@section('title', config('app.name') . ' - Edit Institution')
@section('page_title', 'Edit Institution')
@section('breadcrumb', 'Edit Institution')
            ...
            <div class="white_card_header">
                <div class="box_header m-0">
                    <div class="main-title">
                        <h3 class="m-0">Edit Institution</h3>
                        <p class="text-muted mb-0">Update institution information</p>
                    </div>
                </div>
            </div>
                ...
                <form action="{{ route('institutions.update', $institution) }}" method="POST" id="institutionForm">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <select name="type" id="type" class="form-control" required>
                                ...
                                @foreach($types as $key => $label)
                                    <option value="{{ $key }}" {{ old('type', $institution->type) == $key ? 'selected' : '' }}>{{ $label }}</option>
                                @endforeach
                            </select>
                            @error('type')
                                <div class="text-danger">{{ $message }}</div>
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" name="code" class="form-control" value="{{ old('code', $institution->code) }}">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" name="registration_number" class="form-control" value="{{ old('registration_number', $institution->registration_number) }}">
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            ...
                            <select name="district_id" id="district_id" class="form-control">
                                ...
                                <option value="{{ $district->id }}" {{ old('district_id', $institution->district_id) == $district->id ? 'selected' : '' }}>
                                    {{ $district->name }}
                                </option>
                                @endforeach
                            </select>
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <select name="tehsil_id" id="tehsil_id" class="form-control">
                                ...
                                <option value="{{ $tehsil->id }}" 
                                        ...
                                        {{ old('tehsil_id', $institution->tehsil_id) == $tehsil->id ? 'selected' : '' }}>
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <select name="union_council_id" id="union_council_id" class="form-control">
                                ...
                                <option value="{{ $uc->id }}" 
                                        ...
                                        {{ old('union_council_id', $institution->union_council_id) == $uc->id ? 'selected' : '' }}>
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <select name="village_id" id="village_id" class="form-control">
                                ...
                                <option value="{{ $village->id }}" 
                                        ...
                                        {{ old('village_id', $institution->village_id) == $village->id ? 'selected' : '' }}>
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <select name="mohalla_id" id="mohalla_id" class="form-control">
                                ...
                                <option value="{{ $mohalla->id }}" 
                                        ...
                                        {{ old('mohalla_id', $institution->mohalla_id) == $mohalla->id ? 'selected' : '' }}>
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <textarea name="address" class="form-control" rows="3" placeholder="Additional address details">{{ old('address', $institution->address) }}</textarea>
                            @error('address')
                                <div class="text-danger">{{ $message }}</div>
                            @enderror
                        </div>
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" name="principal_director_name" class="form-control" value="{{ old('principal_director_name', $institution->principal_director_name) }}">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" name="phone" class="form-control" value="{{ old('phone', $institution->phone) }}" placeholder="e.g., 0355-1234567">
                            @error('phone')
                                <div class="text-danger">{{ $message }}</div>
                            @enderror
                        </div>
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="email" name="email" class="form-control" value="{{ old('email', $institution->email) }}" placeholder="e.g., info@institution.com">
                            @error('email')
                                <div class="text-danger">{{ $message }}</div>
                            @enderror
                        </div>
                        <div class="col-md-6 mb-3">
                            <div class="form-check mt-4">
                                <input class="form-check-input" type="checkbox" name="is_active" id="is_active" value="1" {{ old('is_active', $institution->is_active) ? 'checked' : '' }}>
