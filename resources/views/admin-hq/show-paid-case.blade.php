...
@section('title', config('app.name') . ' - Paid Case Details')
@section('page_title', 'Paid Case Details')
@section('breadcrumb', 'Paid Case Details')
            ...
            <div class="white_card_header">
                <div class="box_header m-0">
                    ...
                    <div class="header_more_tool">
                        <a href="{{ route('admin-hq.all-cases') }}#paid" class="btn btn-secondary">
            ...
            <div class="white_card_body">
                <div class="row">
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <p class="mb-0"><span class="badge bg-success">{{ $beneficiary->jazzcash_status ?? 'N/A' }}</span></p>
                    </div>
                    <div class="col-md-6 mb-3">
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <p class="mb-0">{{ $beneficiary->payment_received_at ? $beneficiary->payment_received_at->format('Y-m-d H:i:s') : 'N/A' }}</p>
                    </div>
