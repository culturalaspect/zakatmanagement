...
@section('title', config('app.name') . ' - Approved Case Details')
@section('page_title', 'Approved Case Details')
@section('breadcrumb', 'Approved Case Details')
    ...
    <div class="col-lg-12">
        <div class="white_card mb_30">
            <div class="white_card_header">
                <div class="box_header m-0">
                    ...
                    <div class="header_more_tool">
                        <a href="{{ route('admin-hq.all-cases') }}?tab=approved" class="btn btn-secondary">
            ...
            <div class="white_card_body">
                ...
                @if($beneficiary->admin_remarks || $beneficiary->district_remarks)
                <hr class="my-4">
                <div class="row">
                    <div class="col-md-12 mb-4">
