...
@section('title', config('app.name') . ' - Add LZC Member')
@section('page_title', 'Add LZC Member')
@section('breadcrumb', 'Add LZC Member')
        ...
        <div class="white_card mb_30">
            ...
            <div class="white_card_body">
                ...
                <div class="alert alert-info mb-4" role="alert">
                    ...
                    <p class="mb-0">
                        <strong>Committee:</strong> {{ $selectedCommittee->name }}<br>
                        <strong>Code:</strong> {{ $selectedCommittee->code ?? 'N/A' }}<br>
                        <strong>District:</strong> {{ $selectedCommittee->district->name ?? 'N/A' }}
                    </p>
                </div>
                @endif
                <form action="{{ route('lzc-members.store') }}" method="POST">
                    @csrf
                    @if($selectedCommittee)
                        <input type="hidden" name="local_zakat_committee_id" value="{{ $selectedCommittee->id }}">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <select name="local_zakat_committee_id" id="local_zakat_committee_id" class="form-control" required>
                                        ...
                                        <option value="{{ $committee->id }}" data-district-id="{{ $committee->district_id }}" {{ old('local_zakat_committee_id') == $committee->id ? 'selected' : '' }}>
                    ...
                    <div class="card mb-4">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <div class="input-group">
                                <input type="text" name="cnic" id="cnic" class="form-control" value="{{ old('cnic') }}" placeholder="12345-1234567-1" maxlength="15" pattern="[0-9]{5}-[0-9]{7}-[0-9]{1}" required>
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <div class="position-relative">
                                <input type="text" name="father_husband_name" id="father_husband_name" class="form-control" value="{{ old('father_husband_name') }}" required>
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <div class="position-relative">
                                <input type="text" name="mobile_number" id="mobile_number" class="form-control" value="{{ old('mobile_number') }}" placeholder="03XX-XXXXXXX" maxlength="12" pattern="03[0-9]{2}-[0-9]{7}">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" name="designation" id="designation" class="form-control" value="{{ old('designation') }}" placeholder="e.g., Chairman, Secretary, Member" required>
                            @error('designation')
                                <div class="text-danger">{{ $message }}</div>
                            @enderror
                        </div>
                    ...
                    <div class="row">
                        <div class="col-12">
                            ...
                            <a href="{{ route('local-zakat-committees.show', $selectedCommitteeId) }}" class="btn btn-secondary">Back to Committee</a>
                            @endif
                        </div>
                    </div>
                </form>
