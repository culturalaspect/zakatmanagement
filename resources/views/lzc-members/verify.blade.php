...
@section('title', config('app.name') . ' - Verify LZC Member')
@section('page_title', 'Verify LZC Member')
@section('breadcrumb', 'Verify LZC Member')
    ...
    <div class="col-lg-12">
        <div class="white_card mb_30">
            ...
            <div class="white_card_body">
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <div class="position-relative">
                                    <input type="text" id="verifyCnic" class="form-control" value="{{ $lZCMember->cnic }}" readonly style="background-color: #fff; border: 1px solid #ced4da;">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <div class="position-relative">
                                    <input type="text" id="verifyFullName" class="form-control" value="{{ $lZCMember->full_name }}" readonly style="background-color: #fff; border: 1px solid #ced4da;">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <div class="position-relative">
                                    <input type="text" id="verifyFatherHusbandName" class="form-control" value="{{ $lZCMember->father_husband_name }}" readonly style="background-color: #fff; border: 1px solid #ced4da;">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <div class="position-relative">
                                    <input type="text" id="verifyMobile" class="form-control" value="{{ $lZCMember->mobile_number ?? 'N/A' }}" readonly style="background-color: #fff; border: 1px solid #ced4da;">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <div class="position-relative">
                                    <input type="text" id="verifyDateOfBirth" class="form-control" value="{{ $lZCMember->date_of_birth ? \Carbon\Carbon::parse($lZCMember->date_of_birth)->format('d M Y') : 'N/A' }}" readonly style="background-color: #fff; border: 1px solid #ced4da;">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <div class="position-relative">
                                    <input type="text" id="verifyGender" class="form-control" value="{{ $genderDisplay }}" readonly style="background-color: #fff; border: 1px solid #ced4da;">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" class="form-control" value="{{ $lZCMember->start_date ? \Carbon\Carbon::parse($lZCMember->start_date)->format('d M Y') : 'N/A' }}" readonly style="background-color: #fff; border: 1px solid #ced4da;">
                            </div>
                            <div class="col-md-6 mb-3">
                                <label class="form-label"><strong>End Date:</strong></label>
                                <input type="text" class="form-control" value="{{ $lZCMember->end_date ? \Carbon\Carbon::parse($lZCMember->end_date)->format('d M Y') : 'Ongoing' }}" readonly style="background-color: #fff; border: 1px solid #ced4da;">
                            </div>
                            <div class="col-md-6 mb-3">
                                <label class="form-label"><strong>Committee:</strong></label>
                                <input type="text" class="form-control" value="{{ $lZCMember->localZakatCommittee->name ?? 'N/A' }}" readonly style="background-color: #fff; border: 1px solid #ced4da;">
                            </div>
                            <div class="col-md-6 mb-3">
                ...
                <form action="{{ route('lzc-members.verify.submit', $lZCMember) }}" method="POST">
                    @csrf
                    <div class="row">
                        <div class="col-md-12 mb-3">
                            ...
                            <select name="action" id="verifyAction" class="form-control" required>
                                ...
                                <option value="verify" {{ old('action') == 'verify' ? 'selected' : '' }}>Verify & Activate</option>
                        ...
                        <div class="col-md-12 mb-3" id="verificationRemarksDiv" style="display: none;">
                            ...
                            <textarea name="verification_remarks" id="verificationRemarks" class="form-control" rows="3" placeholder="Enter remarks for verification">{{ old('verification_remarks') }}</textarea>
                        ...
                        <div class="col-md-12 mb-3" id="rejectionReasonDiv" style="display: none;">
                            ...
                            <textarea name="rejection_reason" id="rejectionReason" class="form-control" rows="3" placeholder="Enter reason for rejection">{{ old('rejection_reason') }}</textarea>
