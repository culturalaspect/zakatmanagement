...
@section('title', config('app.name') . ' - Phase Details')
@section('page_title', 'Phase Details')
@section('breadcrumb', 'Phase Details')
            ...
            <div class="white_card_header">
                <div class="box_header m-0">
                    <div class="main-title">
                        <h3 class="m-0">Phase Details</h3>
                    </div>
                    <div class="header_more_tool">
                        <a href="{{ route('beneficiary-applications.index') }}" class="btn btn-secondary">
                            <i class="ti-arrow-left"></i> Back to Applications
                        </a>
                        <a href="{{ route('phases.edit', $phase) }}" class="btn btn-primary">
                            <i class="ti-pencil"></i> Edit Phase
                        </a>
                        <form action="{{ route('phases.destroy', $phase) }}" method="POST" class="d-inline" onsubmit="return confirmDelete(event, 'Are you sure you want to delete this phase?')">
                            @csrf
                            @method('DELETE')
                            <button type="submit" class="btn btn-danger">
                                <i class="ti-trash"></i> Delete Phase
                            </button>
                        </form>
                    </div>
                </div>
            ...
            <div class="white_card_body">
                ...
                <div class="row mb-4">
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <p><strong class="text-primary">{{ $phase->name }}</strong></p>
                    </div>
                    <div class="col-md-6 mb-3">
                        <strong>Phase Number:</strong>
                        <p>{{ $phase->phase_number }}</p>
                    </div>
                    <div class="col-md-6 mb-3">
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <p>{{ $phase->district->name ?? 'N/A' }}</p>
                    </div>
                    @if($phase->scheme)
                    <div class="col-md-6 mb-3">
                        <strong>Scheme:</strong>
                        <p>{{ $phase->scheme->name ?? 'N/A' }}</p>
                    </div>
                    @endif
                </div>
                ...
                <div class="row mb-4">
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <p>Installment {{ $phase->installment->installment_number }}</p>
                    </div>
                    <div class="col-md-6 mb-3">
                        <strong>Financial Year:</strong>
                        <p>{{ $phase->installment->fundAllocation->financialYear->name ?? 'N/A' }}</p>
                    </div>
                    <div class="col-md-6 mb-3">
                        <strong>Installment Amount:</strong>
                        <p><strong class="text-success">Rs. {{ number_format($phase->installment->installment_amount, 2) }}</strong></p>
                    </div>
                    <div class="col-md-6 mb-3">
                        <strong>Installment Date:</strong>
                        <p>{{ $phase->installment->installment_date ? \Carbon\Carbon::parse($phase->installment->installment_date)->format('d M Y') : 'N/A' }}</p>
                    </div>
                    @else
                    <div class="col-md-12">
                ...
                <div class="row mb-4">
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <p><strong class="text-primary">{{ number_format($phase->max_beneficiaries) }}</strong></p>
                    </div>
                    <div class="col-md-6 mb-3">
                        <strong>Max Amount:</strong>
                        <p><strong class="text-success">Rs. {{ number_format($phase->max_amount, 2) }}</strong></p>
                    </div>
                    <div class="col-md-6 mb-3">
                        <strong>Start Date:</strong>
                        <p>{{ $phase->start_date ? \Carbon\Carbon::parse($phase->start_date)->format('d M Y') : 'N/A' }}</p>
                    </div>
                    <div class="col-md-6 mb-3">
                        <strong>End Date:</strong>
                        <p>{{ $phase->end_date ? \Carbon\Carbon::parse($phase->end_date)->format('d M Y') : 'N/A' }}</p>
                    </div>
                </div>
                                        ...
                                        <div class="col-md-3 mb-3">
                                            ...
                                            <select id="filterStatus" class="form-control form-control-sm">
                                                ...
                                                @foreach($uniqueStatuses as $status)
                                                    <option value="{{ ucfirst($status) }}">{{ ucfirst($status) }}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                    </div>
                            ...
                            <tbody id="beneficiariesTableBody">
                                ...
                                <tr data-beneficiary-id="{{ $beneficiary->id }}">
                                    ...
                                    <td>
                                        ...
                                        @elseif($beneficiary->status == 'submitted')
                                        ...
                                        @else
                                            <span class="badge bg-secondary">{{ ucfirst($beneficiary->status ?? 'N/A') }}</span>
                                        @endif
                                    </td>
                                    <td>
                                        <div class="action_btns d-flex">
                                            ...
                                            @endif
                                            @if($beneficiary->status == 'pending' || $beneficiary->status == 'submitted')
                                            ...
                                            <button type="button" class="action_btn mr_10 deleteBeneficiaryBtn" 
                                                    data-beneficiary-id="{{ $beneficiary->id }}" 
                                                    data-beneficiary-name="{{ $beneficiary->full_name }}" 
                                                    title="Delete">
                                                <i class="ti-trash"></i>
                                            </button>
                                        </div>
...
<script>
    $(document).ready(function() {
        ...
        const phaseSchemeId = {{ $phase->scheme_id ?? 0 }};
        const phaseSchemeName = @json($phase->scheme->name ?? 'N/A');
        const phaseScheme = @json($phase->scheme ?? null);
            ...
            Swal.fire({
                ...
                html: `
                    <form id="addBeneficiaryForm" style="text-align: left;">
                        ...
                        <div class="card mb-3" style="background-color: #f8f9fa; border: 1px solid #dee2e6;">
                            <div class="card-body">
                                <h6 class="card-title mb-3">Institution Selection</h6>
                                <div class="row">
                                    <div class="col-md-12 mb-3">
                ...
                didOpen: () => {
                    ...
                    if (phaseSchemeId) {
                        ...
                        $.ajax({
                            url: '{{ route("beneficiaries.scheme-categories", ":id") }}'.replace(':id', phaseSchemeId),
                            type: 'GET',
                ...
                preConfirm: () => {
                    ...
                    // Validate LZC or Institution selection based on scheme type (reuse isInstitutional from above)
                    if (isInstitutional) {
                    ...
                    return $.ajax({
                        url: '{{ route("beneficiaries.store-ajax") }}',
                        type: 'POST',
                        data: data,
                        headers: {
                        ...
                        error: function(xhr) {
                                    ...
                                    html: `
                                        <div style="text-align: left; padding: 10px 0;">
                                            ...
                                            <div style="border-top: 1px solid #dee2e6; padding-top: 15px; margin-top: 15px;">
                                                <p style="margin: 5px 0; font-weight: 600;">Existing Registration Details:</p>
                                                <table style="width: 100%; margin-top: 10px;">
                                                    <tr>
                                                        <td style="padding: 5px 0; width: 40%;"><strong>CNIC:</strong></td>
                                                        <td style="padding: 5px 0;">${details.cnic || 'N/A'}</td>
                                                    </tr>
                                                    <tr>
                                                        <td style="padding: 5px 0;"><strong>Name:</strong></td>
                                                        <td style="padding: 5px 0;">${details.full_name || 'N/A'}</td>
                                                    </tr>
                                                    <tr>
                                                        <td style="padding: 5px 0;"><strong>Scheme:</strong></td>
                                                        <td style="padding: 5px 0;">${details.scheme_name || 'N/A'}</td>
                                                    </tr>
                                                    <tr>
                                                        <td style="padding: 5px 0;"><strong>Phase:</strong></td>
                                                        <td style="padding: 5px 0;">${details.phase_name || 'N/A'}</td>
                                                    </tr>
                                                    <tr>
                                                        <td style="padding: 5px 0;"><strong>District:</strong></td>
                                                        <td style="padding: 5px 0;">${details.district_name || 'N/A'}</td>
                                                    </tr>
                                                    <tr>
                                                        <td style="padding: 5px 0;"><strong>Committee:</strong></td>
                                                        <td style="padding: 5px 0;">${details.committee_name || 'N/A'}</td>
                                                    </tr>
                                                    <tr>
                                                        <td style="padding: 5px 0;"><strong>Status:</strong></td>
                                                        <td style="padding: 5px 0;"><span class="badge bg-info">${details.status || 'N/A'}</span></td>
                                                    </tr>
                                                    <tr>
                                                        <td style="padding: 5px 0;"><strong>Financial Year:</strong></td>
                                                        <td style="padding: 5px 0;">${details.financial_year || 'N/A'}</td>
                                                    </tr>
                                                    <tr>
                                                        <td style="padding: 5px 0;"><strong>Registered Date:</strong></td>
                                                        <td style="padding: 5px 0;">${details.registered_date || 'N/A'}</td>
                                                    </tr>
                                                </table>
                                            </div>
                                        </div>
                            ...
                            // For other errors (including phase limit errors), show in validation message
        ...
        function editBeneficiary(beneficiaryId) {
            ...
            $.ajax({
                url: '{{ route("beneficiaries.get-details", ":id") }}'.replace(':id', beneficiaryId),
                type: 'GET',
                success: function(response) {
                    if (response.success) {
        ...
        function showEditBeneficiaryModal(beneficiary) {
            ...
            Swal.fire({
                ...
                preConfirm: () => {
                    ...
                    return $.ajax({
                        url: '{{ route("beneficiaries.update-ajax", ":id") }}'.replace(':id', beneficiary.id),
                        type: 'POST',
                        data: data,
                        headers: {
                            'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
        ...
        function deleteBeneficiary(beneficiaryId, beneficiaryName) {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    $.ajax({
                        url: '{{ route("beneficiaries.delete-ajax", ":id") }}'.replace(':id', beneficiaryId),
                        type: 'DELETE',
                        headers: {
                            'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
                        },
        ...
        function showVerifyBeneficiaryModal(beneficiary) {
            ...
            Swal.fire({
                ...
                preConfirm: () => {
                    ...
                    return $.ajax({
                        url: '{{ route("beneficiaries.verify-ajax", ":id") }}'.replace(':id', beneficiary.id),
                        type: 'POST',
                        data: {
                            action: 'submit',
