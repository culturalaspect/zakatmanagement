...
<div class="row">
    <div class="col-xl-3 col-md-6">
        <div class="card mb-3 widget-chart card-hover-shadow-2x">
            ...
            <div class="widget-numbers"><span>{{ formatNumber($data['total_beneficiaries'] ?? 0) }}</span></div>
    ...
    <div class="col-xl-3 col-md-6">
        <div class="card mb-3 widget-chart card-hover-shadow-2x">
            ...
            <div class="widget-numbers"><span>{{ formatNumber($data['approved_beneficiaries'] ?? 0) }}</span></div>
    ...
    <div class="col-xl-3 col-md-6">
        <div class="card mb-3 widget-chart card-hover-shadow-2x">
            ...
            <div class="widget-numbers"><span>{{ formatNumber($data['paid_beneficiaries'] ?? 0) }}</span></div>
    ...
    <div class="col-xl-3 col-md-6">
        <div class="card mb-3 widget-chart card-hover-shadow-2x">
            ...
            <div class="widget-numbers"><span>{{ formatNumber($data['pending_beneficiaries'] ?? 0) }}</span></div>
...
<div class="row">
    ...
    <div class="col-xl-3 col-md-6">
        <div class="card mb-3 widget-chart card-hover-shadow-2x">
            ...
            <div class="widget-numbers"><span>{{ formatCurrency($data['total_funds'] ?? 0) }}</span></div>
    ...
    <div class="col-xl-3 col-md-6">
        <div class="card mb-3 widget-chart card-hover-shadow-2x">
            ...
            <div class="widget-numbers"><span>{{ formatCurrency($data['disbursed_funds'] ?? 0) }}</span></div>
    ...
    <div class="col-xl-3 col-md-6">
        <div class="card mb-3 widget-chart card-hover-shadow-2x">
            ...
            <div class="widget-numbers"><span>{{ formatNumber($data['districts'] ?? 0) }}</span></div>
    ...
    <div class="col-xl-3 col-md-6">
        <div class="card mb-3 widget-chart card-hover-shadow-2x">
            ...
            <div class="widget-numbers"><span>{{ formatNumber($data['active_phases'] ?? 0) }}</span></div>
    ...
    <div class="col-xl-3 col-md-6">
        <div class="card mb-3 widget-chart card-hover-shadow-2x">
            ...
            <div class="widget-numbers"><span>{{ formatNumber($data['submitted_beneficiaries'] ?? 0) }}</span></div>
    ...
    <div class="col-xl-3 col-md-6">
        <div class="card mb-3 widget-chart card-hover-shadow-2x">
            ...
            <div class="widget-numbers"><span>{{ formatNumber($data['rejected_beneficiaries'] ?? 0) }}</span></div>
...
<div class="row">
    ...
    <div class="col-xl-3 col-md-6">
        <div class="card mb-3 widget-chart card-hover-shadow-2x">
            ...
            <div class="widget-numbers"><span>{{ formatNumber($data['payment_failed_beneficiaries'] ?? 0) }}</span></div>
    ...
    <div class="col-xl-3 col-md-6">
        <div class="card mb-3 widget-chart card-hover-shadow-2x">
            ...
            <div class="widget-numbers"><span>{{ formatNumber($data['schemes'] ?? 0) }}</span></div>
    ...
    <div class="col-xl-3 col-md-6">
        <div class="card mb-3 widget-chart card-hover-shadow-2x">
            ...
            <div class="widget-numbers"><span>{{ formatNumber($data['committees'] ?? 0) }}</span></div>
        ...
        <div class="white_card card_height_100 mb_30 sales_card_wrapper">
            ...
            <div class="sales_card_body">
                <div class="single_sales">
                    ...
                    <h3>{{ formatNumber($data['paid_beneficiaries'] ?? 0) }}</h3>
                </div>
                <div class="single_sales">
                    <span>Total Beneficiaries</span>
                    <h3>{{ formatNumber($data['total_beneficiaries'] ?? 0) }}</h3>
                </div>
                <div class="single_sales">
                    <span>Disbursed Funds</span>
                    <h3>{{ formatCurrency($data['disbursed_funds'] ?? 0) }}</h3>
                </div>
                <div class="single_sales">
                    <span>Total Funds</span>
                    <h3>{{ formatCurrency($data['total_funds'] ?? 0) }}</h3>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="white_card card_height_100 mb_30 social_media_card">
            ...
            <div class="media_card_body">
                <div class="media_card_list">
                    ...
                    @endphp
                    @forelse($topSchemes as $index => $scheme)
                    <div class="single_media_card" style="background: {{ $schemeColors[$index % 4]['bg'] }};">
                        <span style="color: {{ $schemeColors[$index % 4]['span'] }};">{{ $scheme->name }}</span>
                        <h3 style="color: {{ $schemeColors[$index % 4]['h3'] }};">{{ number_format($scheme->beneficiaries_count ?? 0) }}</h3>
                    </div>
                    @empty
                    @for($i = 0; $i < 4; $i++)
                    <div class="single_media_card" style="background: {{ $schemeColors[$i]['bg'] }};">
                        <span style="color: {{ $schemeColors[$i]['span'] }};">No Data</span>
                        <h3 style="color: {{ $schemeColors[$i]['h3'] }};">0</h3>
                    </div>
                    @endfor
                    @endforelse
                </div>
        ...
        <div class="white_card card_height_100 mb_30">
            <div class="white_card_header">
                <div class="box_header m-0">
                    <div class="main-title">
                        ...
                        <span>{{ number_format($data['total_beneficiaries'] ?? 0) }} Beneficiaries</span>
                    </div>
            ...
            <div class="white_card_body">
                ...
                <div class="monthly_plan_wraper">
                    @forelse($data['top_districts']->take(3) ?? [] as $district)
                    <div class="single_plan d-flex align-items-center justify-content-between">
                        ...
                        <span class="brouser_btn">{{ number_format($district->beneficiaries_count ?? 0) }}</span>
                    </div>
                    @empty
                    <div class="single_plan d-flex align-items-center justify-content-between">
                        <div class="plan_left d-flex align-items-center">
        ...
        <div class="white_card card_height_100 mb_30">
            <div class="white_card_header">
                <div class="main-title">
                    ...
                    <span>{{ number_format($data['total_beneficiaries'] ?? 0) }} Total</span>
                </div>
            </div>
            <div class="white_card_body">
                    ...
                    <div class="white_card_body QA_section">
                        <div class="QA_table">
                            <table class="table lms_table_active2 p-0">
                                ...
                                <tbody>
                                    @forelse($data['recent_beneficiaries'] ?? [] as $beneficiary)
                                    <tr>
                                        <td>
                                            <div class="customer d-flex align-items-center">
                                                ...
                                                <div class="ml_18">
                                                    <h3 class="f_s_16 f_w_900 mb-0">{{ $beneficiary->full_name }}</h3>
                                                    <span class="f_s_11 f_w_700 text_color_8">{{ $beneficiary->cnic }}</span>
                                                </div>
                                            </div>
                                        </td>
                                        <td>
                                            <div>
                                                <h3 class="f_s_16 f_w_800 mb-0">{{ $beneficiary->scheme->name ?? 'N/A' }}</h3>
                                                <span class="f_s_11 f_w_500 color_text_3">{{ $beneficiary->schemeCategory->name ?? 'N/A' }}</span>
                                            </div>
                                        </td>
                                        <td>
                                            <div>
                                                <h3 class="f_s_16 f_w_800 mb-0">{{ $beneficiary->phase->district->name ?? 'N/A' }}</h3>
                                                <span class="f_s_11 f_w_500 color_text_3">{{ $beneficiary->localZakatCommittee->name ?? 'N/A' }}</span>
                                            </div>
                                        </td>
                                        ...
                                        <td>
                                            <div>
                                                <h3 class="f_s_16 f_w_900 mb-0">Rs. {{ number_format($beneficiary->amount, 2) }}</h3>
                                            </div>
                                        </td>
                                    </tr>
                                    @empty
                ...
                <div class="col-lg-3 white_card_body pt_25">
                        ...
                        <div class="single_pro d-flex">
                            ...
                            <div class="box_content">
                                <h4>{{ formatNumber($data['approved_beneficiaries'] ?? 0) }}</h4>
                                <span>Approved</span>
                            </div>
                        </div>
                        <div class="single_pro d-flex">
                            ...
                            <div class="box_content">
                                <h4 class="bluish_text">{{ formatNumber($data['paid_beneficiaries'] ?? 0) }}</h4>
                        ...
                        <div class="single_pro d-flex">
                            ...
                            <div class="box_content">
                                <h4 style="color: #ffc107;">{{ formatNumber($data['pending_beneficiaries'] ?? 0) }}</h4>
    ...
    <div class="col-xl-4">
        <div class="white_card card_height_100 mb_30">
            <div class="white_card_header">
                <div class="box_header m-0">
                    <div class="main-title">
                        ...
                        <span>{{ number_format(collect($data['active_phases_list'] ?? [])->sum('beneficiaries_count')) }} Beneficiaries</span>
                    </div>
                    <div class="float-lg-right float-none common_tab_btn justify-content-end">
                        <ul class="nav">
                            <li class="nav-item">
            ...
            <div class="white_card_body">
                ...
                <div class="monthly_plan_wraper">
                    @forelse($data['active_phases_list']->take(3) ?? [] as $phase)
                    <div class="single_plan d-flex align-items-center justify-content-between">
                        <div class="plan_left d-flex align-items-center">
                            <div class="thumb">
                            ...
                            <div>
                                <h5>{{ $phase->scheme->name ?? 'N/A' }}</h5>
                                <span>Phase</span>
                            </div>
                        </div>
                        <span class="brouser_btn">{{ number_format($phase->beneficiaries_count ?? 0) }}</span>
                    </div>
                    @empty
                    <div class="single_plan d-flex align-items-center justify-content-between">
                        <div class="plan_left d-flex align-items-center">
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    var trendsData = @json($data['monthly_trends'] ?? []);
    ...
    var districtData = @json($data['top_districts'] ?? []);
    ...
    var paymentData = @json($data['payment_status'] ?? []);
    ...
    var overallApprovalRate = {{ $data['total_beneficiaries'] > 0 ? round(($data['approved_beneficiaries'] / $data['total_beneficiaries']) * 100, 0) : 0 }};
    ...
    // Scheme-wise Chart
    var schemeData = @json($data['scheme_stats'] ?? []);
    ...
    var districtPaymentData = {
        paid: {{ $data['paid_beneficiaries'] ?? 0 }},
        payment_failed: {{ $data['rejected_beneficiaries'] ?? 0 }},
        pending_payment: {{ $data['approved_beneficiaries'] ?? 0 }}
    };
    ...
    var activePhasesData = @json($data['active_phases_list'] ?? []);
    ...
    var districtTrendsData = @json($data['monthly_trends'] ?? []);
