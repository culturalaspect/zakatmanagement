...
@section('title', config('app.name') . ' - Edit District')
@section('page_title', 'Edit District')
@section('breadcrumb', 'Edit District')
            ...
            <div class="white_card_body">
                <form action="{{ route('districts.update', $district) }}" method="POST">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-3">
                            <label class="form-label">Population <span class="text-danger">*</span></label>
                            <input type="number" name="population" class="form-control" value="{{ old('population', $district->population) }}" min="0" required>
                            @error('population')
                                <div class="text-danger">{{ $message }}</div>
                            @enderror
                        </div>
