...
@section('title', config('app.name') . ' - Districts')
                    ...
                    <div class="table-responsive">
                        <table class="table" id="districtsTable">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td>{{ $district->name }}</td>
                                    <td>{{ number_format($district->population) }}</td>
                                    <td data-status="{{ $district->is_active ? 'active' : 'inactive' }}">
                                ...
                                <td>
                                    <div class="action_btns d-flex">
                                        <a href="{{ route('districts.show', $district) }}" class="action_btn mr_10" title="View">
                                            <i class="ti-eye"></i>
                                        </a>
                                        <a href="{{ route('districts.edit', $district) }}" class="action_btn mr_10" title="Edit">
                                            <i class="ti-pencil"></i>
                                        </a>
                                        <form action="{{ route('districts.destroy', $district) }}" method="POST" class="d-inline mr_10" onsubmit="return confirmDelete(event, 'Are you sure you want to delete this district?')">
                                            @csrf
                                            @method('DELETE')
