            ...
            <div class="white_card_body">
                <form action="{{ route('schemes.update', $scheme) }}" method="POST" id="schemeForm">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-3">
                            <div class="form-check mt-4">
                                <input class="form-check-input" type="checkbox" name="is_institutional" id="is_institutional" value="1" {{ old('is_institutional', $scheme->is_institutional) ? 'checked' : '' }}>
                        ...
                        <div class="col-md-12 mb-3" id="institutionalTypeDiv" style="display: {{ old('is_institutional', $scheme->is_institutional) ? 'block' : 'none' }};">
                            <label class="form-label">Institutional Type <span class="text-danger">*</span></label>
                            <div class="form-check">
                                <input class="form-check-input" type="radio" name="institutional_type" id="institutional_educational" value="educational" {{ old('institutional_type', $scheme->institutional_type) == 'educational' ? 'checked' : '' }}>
                                <label class="form-check-label" for="institutional_educational">Educational Stipend</label>
                            </div>
                            <div class="form-check">
                                <input class="form-check-input" type="radio" name="institutional_type" id="institutional_madarsa" value="madarsa" {{ old('institutional_type', $scheme->institutional_type) == 'madarsa' ? 'checked' : '' }}>
                                <label class="form-check-label" for="institutional_madarsa">Madarsa Stipend</label>
                            </div>
                            <div class="form-check">
                                <input class="form-check-input" type="radio" name="institutional_type" id="institutional_health" value="health" {{ old('institutional_type', $scheme->institutional_type) == 'health' ? 'checked' : '' }}>
                        ...
                        <div class="col-md-6 mb-3">
                            <div class="form-check mt-4">
                                <input class="form-check-input" type="checkbox" name="allows_representative" id="allows_representative" value="1" {{ old('allows_representative', $scheme->allows_representative) ? 'checked' : '' }}>
                    ...
                    <div class="row">
                        <div class="col-md-4 mb-3">
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" name="beneficiary_required_fields[]" id="benef_cnic" value="cnic" {{ in_array('cnic', old('beneficiary_required_fields', $scheme->beneficiary_required_fields ?? [])) ? 'checked' : '' }}>
                                <label class="form-check-label" for="benef_cnic">CNIC</label>
                            </div>
                        </div>
                        <div class="col-md-4 mb-3">
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" name="beneficiary_required_fields[]" id="benef_full_name" value="full_name" {{ in_array('full_name', old('beneficiary_required_fields', $scheme->beneficiary_required_fields ?? [])) ? 'checked' : '' }}>
                                <label class="form-check-label" for="benef_full_name">Full Name</label>
                            </div>
                        </div>
                        <div class="col-md-4 mb-3">
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" name="beneficiary_required_fields[]" id="benef_father_husband_name" value="father_husband_name" {{ in_array('father_husband_name', old('beneficiary_required_fields', $scheme->beneficiary_required_fields ?? [])) ? 'checked' : '' }}>
                                <label class="form-check-label" for="benef_father_husband_name">Father / Husband Name</label>
                            </div>
                        </div>
                        <div class="col-md-4 mb-3">
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" name="beneficiary_required_fields[]" id="benef_mobile_number" value="mobile_number" {{ in_array('mobile_number', old('beneficiary_required_fields', $scheme->beneficiary_required_fields ?? [])) ? 'checked' : '' }}>
                                <label class="form-check-label" for="benef_mobile_number">Mobile Number</label>
                            </div>
                        </div>
                        <div class="col-md-4 mb-3">
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" name="beneficiary_required_fields[]" id="benef_date_of_birth" value="date_of_birth" {{ in_array('date_of_birth', old('beneficiary_required_fields', $scheme->beneficiary_required_fields ?? [])) ? 'checked' : '' }}>
                                <label class="form-check-label" for="benef_date_of_birth">Date of Birth</label>
                            </div>
                        </div>
                        <div class="col-md-4 mb-3">
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" name="beneficiary_required_fields[]" id="benef_gender" value="gender" {{ in_array('gender', old('beneficiary_required_fields', $scheme->beneficiary_required_fields ?? [])) ? 'checked' : '' }}>
                                <label class="form-check-label" for="benef_gender">Gender</label>
                            </div>
                        </div>
                    </div>

                    <div id="representativeFieldsSection" style="display: {{ old('allows_representative', $scheme->allows_representative) ? 'block' : 'none' }};">
                        <hr class="my-4">
                        ...
                        <div class="row">
                            <div class="col-md-4 mb-3">
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" name="representative_required_fields[]" id="rep_cnic" value="cnic" {{ in_array('cnic', old('representative_required_fields', $scheme->representative_required_fields ?? [])) ? 'checked' : '' }}>
                                    <label class="form-check-label" for="rep_cnic">CNIC</label>
                                </div>
                            </div>
                            <div class="col-md-4 mb-3">
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" name="representative_required_fields[]" id="rep_full_name" value="full_name" {{ in_array('full_name', old('representative_required_fields', $scheme->representative_required_fields ?? [])) ? 'checked' : '' }}>
                                    <label class="form-check-label" for="rep_full_name">Full Name</label>
                                </div>
                            </div>
                            <div class="col-md-4 mb-3">
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" name="representative_required_fields[]" id="rep_father_husband_name" value="father_husband_name" {{ in_array('father_husband_name', old('representative_required_fields', $scheme->representative_required_fields ?? [])) ? 'checked' : '' }}>
                                    <label class="form-check-label" for="rep_father_husband_name">Father / Husband Name</label>
                                </div>
                            </div>
                            <div class="col-md-4 mb-3">
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" name="representative_required_fields[]" id="rep_mobile_number" value="mobile_number" {{ in_array('mobile_number', old('representative_required_fields', $scheme->representative_required_fields ?? [])) ? 'checked' : '' }}>
                                    <label class="form-check-label" for="rep_mobile_number">Mobile Number</label>
                                </div>
                            </div>
                            <div class="col-md-4 mb-3">
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" name="representative_required_fields[]" id="rep_date_of_birth" value="date_of_birth" {{ in_array('date_of_birth', old('representative_required_fields', $scheme->representative_required_fields ?? [])) ? 'checked' : '' }}>
                                    <label class="form-check-label" for="rep_date_of_birth">Date of Birth</label>
                                </div>
                            </div>
                            <div class="col-md-4 mb-3">
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" name="representative_required_fields[]" id="rep_gender" value="gender" {{ in_array('gender', old('representative_required_fields', $scheme->representative_required_fields ?? [])) ? 'checked' : '' }}>
