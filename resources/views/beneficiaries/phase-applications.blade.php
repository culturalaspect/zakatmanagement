...
@section('title', config('app.name') . ' - Beneficiary Applications')
@section('page_title', 'Beneficiary Applications')
@section('breadcrumb', 'Beneficiary Applications')
            ...
            <div class="white_card_header">
                <div class="box_header m-0">
                    <div class="main-title">
                        <h3 class="m-0">Manage Beneficiaries - {{ $phase->name }}</h3>
                    </div>
