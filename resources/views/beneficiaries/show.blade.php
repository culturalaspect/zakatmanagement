...
@section('title', config('app.name') . ' - Beneficiary Details')
@section('page_title', 'Beneficiary Details')
            ...
            <div class="white_card_header">
                <div class="box_header m-0">
                    ...
                    <div class="header_more_tool">
                        ...
                        @if(in_array($beneficiary->status, ['pending', 'rejected']))
                        <a href="{{ route('beneficiaries.edit', $beneficiary) }}" class="btn btn-primary">
                            <i class="ti-pencil"></i> Edit
                        </a>
                        @endif
                        @if(auth()->user()->isAdministratorHQ() || auth()->user()->isSuperAdmin())
                            @if($beneficiary->status == 'submitted')
                            <button type="button" class="btn btn-success" id="approveBeneficiaryBtn" data-beneficiary-id="{{ $beneficiary->id }}">
                                <i class="ti-check"></i> Approve
                            </button>
                            <button type="button" class="btn btn-danger" id="rejectBeneficiaryBtn" data-beneficiary-id="{{ $beneficiary->id }}">
            ...
            <div class="white_card_body">
                <div class="row">
                    ...
                    <div class="col-md-6 mb-3">
                        <strong>CNIC:</strong>
                        <p class="mb-0" id="show_cnic">{{ $beneficiary->cnic ?? 'N/A' }}</p>
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <p class="mb-0" id="show_full_name">{{ $beneficiary->full_name ?? 'N/A' }}</p>
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <p class="mb-0" id="show_father_husband_name">{{ $beneficiary->father_husband_name ?? 'N/A' }}</p>
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <p class="mb-0" id="show_mobile_number">{{ $beneficiary->mobile_number ?? 'N/A' }}</p>
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <p class="mb-0" id="show_date_of_birth">{{ $beneficiary->date_of_birth ? \Carbon\Carbon::parse($beneficiary->date_of_birth)->format('d M Y') : 'N/A' }}</p>
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 mb-3">
                        <strong>CNIC:</strong>
                        <p class="mb-0" id="show_rep_cnic">{{ $beneficiary->representative->cnic ?? 'N/A' }}</p>
                    ...
                    <div class="col-md-6 mb-3">
                        <strong>Full Name:</strong>
                        <p class="mb-0" id="show_rep_full_name">{{ $beneficiary->representative->full_name ?? 'N/A' }}</p>
                    ...
                    <div class="col-md-6 mb-3">
                        <strong>Father/Husband Name:</strong>
                        <p class="mb-0" id="show_rep_father_husband_name">{{ $beneficiary->representative->father_husband_name ?? 'N/A' }}</p>
                    ...
                    <div class="col-md-6 mb-3">
                        <strong>Mobile Number:</strong>
                        <p class="mb-0" id="show_rep_mobile_number">{{ $beneficiary->representative->mobile_number ?? 'N/A' }}</p>
                    ...
                    <div class="col-md-6 mb-3">
                        <strong>Date of Birth:</strong>
                        <p class="mb-0" id="show_rep_date_of_birth">{{ $beneficiary->representative->date_of_birth ? \Carbon\Carbon::parse($beneficiary->representative->date_of_birth)->format('d M Y') : 'N/A' }}</p>
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <p class="mb-0" id="show_rep_relationship">{{ $beneficiary->representative->relationship ?? 'N/A' }}</p>
                ...
                @if($beneficiary->district_remarks || $beneficiary->admin_remarks || $beneficiary->rejection_remarks)
                <hr class="my-4">
                <div class="row">
                    <div class="col-md-12 mb-4">
                    ...
                    <div class="col-md-12 mb-3">
                        ...
                        <p class="mb-0">{{ $beneficiary->admin_remarks }}</p>
                    </div>
                    @endif
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <p class="mb-0">{{ $beneficiary->approved_at->format('d M Y H:i:s') }}</p>
                    </div>
                    @endif
                    @if($beneficiary->approvedBy)
                    <div class="col-md-6 mb-3">
                        <strong>Approved By:</strong>
                        <p class="mb-0">{{ $beneficiary->approvedBy->name ?? 'N/A' }}</p>
                    </div>
                    @endif
                    <div class="col-md-6 mb-3">
...
<script>
    $(document).ready(function() {
        ...
        const beneficiaryCnic = '{{ $beneficiary->cnic }}';
        const representativeCnic = '{{ $beneficiary->representative->cnic ?? '' }}';
        ...
        function showApproveBeneficiaryModal() {
            Swal.fire({
                ...
                html: `
                    <form id="approveBeneficiaryForm" style="text-align: left;">
                        <div class="mb-3">
                            ...
                            <textarea name="admin_remarks" id="approve_admin_remarks" class="form-control" rows="3" placeholder="Enter any remarks or observations...">{{ $beneficiary->admin_remarks ?? '' }}</textarea>
                ...
                preConfirm: () => {
                    ...
                    return $.ajax({
                        url: '{{ route("admin-hq.approve", $beneficiary) }}',
                        type: 'POST',
                        data: {
                        ...
                        success: function(response) {
                            Swal.fire({
                                ...
                                window.location.href = '{{ route("beneficiaries.show", $beneficiary) }}';
                            });
                        },
                        error: function(xhr) {
        ...
        function showRejectBeneficiaryModal() {
            Swal.fire({
                ...
                preConfirm: () => {
                    ...
                    return $.ajax({
                        url: '{{ route("admin-hq.reject", $beneficiary) }}',
                        type: 'POST',
                        data: {
                            admin_remarks: remarks
                        },
