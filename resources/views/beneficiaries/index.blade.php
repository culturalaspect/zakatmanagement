...
@section('title', config('app.name') . ' - Beneficiaries')
                    ...
                    <div class="header_more_tool">
                        <div class="dropdown">
                            ...
                            <div class="dropdown-menu dropdown-menu-right" aria-labelledby="dropdownMenuButton">
                                <a class="dropdown-item" href="{{ route('beneficiaries.create') }}"><i class="ti-plus"></i> Add New</a>
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <table class="table" id="beneficiariesTable">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td data-status="{{ $beneficiary->status }}">
                                ...
                                <td>
                                    <div class="action_btns d-flex">
                                        ...
                                        @endif
                                        @if(in_array($beneficiary->status, ['pending', 'submitted']))
        ...
        function showEditBeneficiaryModal(beneficiary, phaseDistrictId = null) {
            ...
            Swal.fire({
                ...
                didOpen: () => {
                    ...
                    // Setup API handlers - will add in next chunk
