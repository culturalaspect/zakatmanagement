...
@section('title', config('app.name') . ' - Financial Years')
@section('page_title', 'Financial Years')
@section('breadcrumb', 'Financial Years')
                        ...
                        <table class="table" id="financialYearsTable">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>{{ $fy->total_allocation ? 'Rs. ' . number_format($fy->total_allocation, 2) : 'N/A' }}</td>
                                    <td data-status="{{ $fy->is_current ? 'current' : 'inactive' }}">
                                        @if($fy->is_current)
                                ...
                                <td>
                                    <div class="action_btns d-flex">
                                        <a href="{{ route('financial-years.show', $fy) }}" class="action_btn mr_10" title="View">
                                            <i class="ti-eye"></i>
                                        </a>
                                        <a href="{{ route('financial-years.edit', $fy) }}" class="action_btn mr_10" title="Edit">
                                            <i class="ti-pencil"></i>
                                        </a>
                                        @if(!$fy->is_current)
                                            <form action="{{ route('financial-years.set-current', $fy) }}" method="POST" class="d-inline mr_10" onsubmit="return confirm('Are you sure you want to set this as the current financial year?')">
                                                @csrf
                                                @method('POST')
                                        ...
                                        @endif
                                        <form action="{{ route('financial-years.destroy', $fy) }}" method="POST" class="d-inline mr_10" onsubmit="return confirmDelete(event, 'Are you sure you want to delete this financial year?')">
                                            @csrf
                                            @method('DELETE')
