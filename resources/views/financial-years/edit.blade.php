...
@section('title', config('app.name') . ' - Edit Financial Year')
@section('page_title', 'Edit Financial Year')
@section('breadcrumb', 'Edit Financial Year')
            ...
            <div class="white_card_header">
                <div class="box_header m-0">
                    <div class="main-title">
                        <h3 class="m-0">Edit Financial Year</h3>
                    </div>
                </div>
            </div>
                ...
                <form action="{{ route('financial-years.update', $financialYear) }}" method="POST">
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" name="name" class="form-control" value="{{ old('name', $financialYear->name) }}" placeholder="e.g., 2025-26" required>
                            @error('name')
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="number" name="total_allocation" class="form-control" value="{{ old('total_allocation', $financialYear->total_allocation) }}" step="0.01" min="0" placeholder="e.g., 1530055572">
                        ...
                        <div class="col-md-6 mb-3">
                            <div class="form-check mt-4">
                                <input class="form-check-input" type="checkbox" name="is_current" id="is_current" value="1" {{ old('is_current', $financialYear->is_current) ? 'checked' : '' }}>
